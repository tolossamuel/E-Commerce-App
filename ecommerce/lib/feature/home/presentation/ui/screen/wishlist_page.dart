...
class _WishlistPageState extends State<WishlistPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: BlocListener<WithListBloc, WishListState>(
            ...
            slivers: [
              ...
              BlocBuilder<WithListBloc, WishListState>(
                builder: (context, state) {
                  if (state is WishListErrorState && wishList.isEmpty) {
                  ...
                  if ((state is WishListLoadingState ||
                      state is WishListInitialState) && wishList.isEmpty) {
                  ...
                  if (state is WishListLoadedState) {
                    if (state.wishList.isEmpty && wishList.isEmpty) {
                      return SliverFillRemaining(
                        hasScrollBody: false,
                        child: Center(
                          child: CustomText(
                    ...
                    return SliverPadding(
                      ...
                      sliver: SliverList.separated(
                        ...
                        itemBuilder: (context, index) =>
                            WishListDisplay(product: state.wishList.isEmpty? wishList[index] : state.wishList[index]),
                      ),
                    );
                  }
