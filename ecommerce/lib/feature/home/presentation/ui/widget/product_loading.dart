...
class ProductLoadingDisplay extends StatelessWidget {
  const ProductLoadingDisplay({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Shimmer.fromColors(
                    ...
                    highlightColor: Colors.grey[100]!,
                    child: Container(
                      width: widthSize(width, 375, 120),
                      height: heightSize(height, 812, 12),
                      color: ConstColor.textGrey,
                    ),
                  ),
                    ...
                    children: [
                      Shimmer.fromColors(
                        ...
                        child: Container(
                          ...
                          height: widthSize(width, 375, 10),
                          color: ConstColor.textGrey,
                        ),
                      ),
                      SizedBox(width: widthSize(width, 375, 8)),
                      Shimmer.fromColors(
                        baseColor: ConstColor.textGrey,
                        highlightColor: Colors.grey[100]!,
                        child: Container(
